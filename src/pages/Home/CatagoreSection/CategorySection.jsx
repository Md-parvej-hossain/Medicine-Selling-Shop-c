  ...
  return (
    <div>
      <div className="text-center text-gray-500">
        <h1 className="text-4xl font-bold py-5">Your Medicine Box</h1>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-10 p-6">
        {items.map(iten => (
